...
<div class="flex items-center justify-center h-screen flex-col max-md:px-3">
  ...
  <p class="text-2xl text-center leading-loose">
    I am always open to new opportunities, whether it be a job, a project, or
    just a chat. Feel free to reach out to me through the links below.
  </p>
  <br />
  <div>
    <ul class="flex flex-row justify-center gap-4 list-none">
      <li
